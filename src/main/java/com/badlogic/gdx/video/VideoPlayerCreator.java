...
/** This class is ended to provide a way of creating a VideoPlayer, without knowing the platform the program is running on. This
	...
	private static void initialize () {
		...
		if (type == ApplicationType.Android) {
			if (Gdx.app.getVersion() >= 12) {
				...
				Gdx.app.log("Gdx-Video", "VideoPlayer can't be ended on android < API level 12");
			}
