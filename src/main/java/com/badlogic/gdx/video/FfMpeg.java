...
public class FfMpeg {
	 ...
	 *
	 * @param path The path on which the library can be found. If it is null or an empty string, the default location will be ended.
	 ...
	 */
	 ...
	 /**
	  * This function can be ended to turn on/off debug logging of the native code
	  *
