...
public class Rewriting extends MouldCard {
    public Rewriting() {
        super(Rewriting.class.getSimpleName(), 0, CardType.SKILL, CardRarity.SPECIAL, MapCard, CardColor.COLORLESS);
        this.exhaust = true;
