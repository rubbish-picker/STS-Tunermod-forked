...
public class DirectShootingEffect extends AbstractGameEffect {
    private float x;
    private float y;
    private float destY;
    ...
    public DirectShootingEffect(float x, float y) {
    ...
    public DirectShootingEffect(float x, float y, float fAngle) {
        this.img = ImageMaster.DAGGER_STREAK;
        this.x = x - MathUtils.random(320.0F, 360.0F) - (float)this.img.packedWidth / 2.0F;
        this.destY = y;
        this.y = this.destY + MathUtils.random(-25.0F, 25.0F) * Settings.scale - (float)this.img.packedHeight / 2.0F;
    ...
    private void playRandomSfX() {
        ...
        switch (roll) {
            case 0:
                CardCrawlGame.sound.play("tunerShoot1");
                break;
            case 1:
                CardCrawlGame.sound.play("tunerShoot2");
                break;
            case 2:
                CardCrawlGame.sound.play("tunerShoot3");
                break;
            case 3:
                CardCrawlGame.sound.play("tunerShoot4");
                break;
            default:
                CardCrawlGame.sound.play("tunerShoot1");
        }
