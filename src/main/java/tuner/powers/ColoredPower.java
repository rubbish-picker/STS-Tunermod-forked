...
public class ColoredPower extends AbstractPower {
    public static final String POWER_ID = ModHelper.makeID(ColoredPower.class.getSimpleName());
    ...
    public ColoredPower(AbstractCreature owner) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
